...
BEGIN
  ...
  INSERT INTO auth.users (
    ...
    ('00000000-0000-0000-0000-000000000000', p1,  'authenticated','authenticated','matt.henderson@demo.golf',  '','{}','{}','{"provider":"email","providers":["email"]}',now()-'90d'::interval,now()-'90d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p2,  'authenticated','authenticated','happy.gilmore@demo.golf',   '','{}','{}','{"provider":"email","providers":["email"]}',now()-'85d'::interval,now()-'85d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p3,  'authenticated','authenticated','shooter.mcgavin@demo.golf', '','{}','{}','{"provider":"email","providers":["email"]}',now()-'84d'::interval,now()-'84d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p4,  'authenticated','authenticated','chubbs.peterson@demo.golf', '','{}','{}','{"provider":"email","providers":["email"]}',now()-'83d'::interval,now()-'83d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p5,  'authenticated','authenticated','doug.thompson@demo.golf',   '','{}','{}','{"provider":"email","providers":["email"]}',now()-'82d'::interval,now()-'82d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p6,  'authenticated','authenticated','billy.madison@demo.golf',   '','{}','{}','{"provider":"email","providers":["email"]}',now()-'80d'::interval,now()-'80d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p7,  'authenticated','authenticated','mike.chen@demo.golf',       '','{}','{}','{"provider":"email","providers":["email"]}',now()-'79d'::interval,now()-'79d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p8,  'authenticated','authenticated','tommy.mcgee@demo.golf',     '','{}','{}','{"provider":"email","providers":["email"]}',now()-'78d'::interval,now()-'78d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p9,  'authenticated','authenticated','craig.nelson@demo.golf',    '','{}','{}','{"provider":"email","providers":["email"]}',now()-'77d'::interval,now()-'77d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p10, 'authenticated','authenticated','farley.holt@demo.golf',     '','{}','{}','{"provider":"email","providers":["email"]}',now()-'76d'::interval,now()-'76d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p11, 'authenticated','authenticated','jake.morrison@demo.golf',   '','{}','{}','{"provider":"email","providers":["email"]}',now()-'75d'::interval,now()-'75d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p12, 'authenticated','authenticated','tom.burke@demo.golf',       '','{}','{}','{"provider":"email","providers":["email"]}',now()-'74d'::interval,now()-'74d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p13, 'authenticated','authenticated','dave.walsh@demo.golf',      '','{}','{}','{"provider":"email","providers":["email"]}',now()-'73d'::interval,now()-'73d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p14, 'authenticated','authenticated','nick.patterson@demo.golf',  '','{}','{}','{"provider":"email","providers":["email"]}',now()-'72d'::interval,now()-'72d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p15, 'authenticated','authenticated','chris.larson@demo.golf',    '','{}','{}','{"provider":"email","providers":["email"]}',now()-'71d'::interval,now()-'71d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p16, 'authenticated','authenticated','lee.trevino@demo.golf',     '','{}','{}','{"provider":"email","providers":["email"]}',now()-'70d'::interval,now()-'70d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p17, 'authenticated','authenticated','otto.yarbrough@demo.golf',  '','{}','{}','{"provider":"email","providers":["email"]}',now()-'69d'::interval,now()-'69d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p18, 'authenticated','authenticated','virginia.venit@demo.golf',  '','{}','{}','{"provider":"email","providers":["email"]}',now()-'68d'::interval,now()-'68d'::interval,false,false,'','','','',0),
    ('00000000-0000-0000-0000-000000000000', p19, 'authenticated','authenticated','bob.barker@demo.golf',      '','{}','{}','{"provider":"email","providers":["email"]}',now()-'67d'::interval,now()-'67d'::interval,false,false,'','','','',0)
