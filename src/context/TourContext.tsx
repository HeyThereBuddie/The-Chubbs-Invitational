...
const SECTIONS: { key: SectionKey; emoji: string; label: string; desc: string }[] = [
  ...
  { key: 'leaderboard', emoji: '🏆', label: 'Leaderboard',   desc: 'Standings, scorecards & the Waterbury Open' },
...
const STEPS: TourStep[] = [
  ...
  // ── Contests, logged right here on the GPS page ──
  { section: 'gps', route: '/gps', anchor: 'contest-ld', title: 'Longest Drive',
    body: "On a Longest Drive hole this pops up when you walk off the tee — tap Yes to log your bomb. Even if you skip it, a 💥 Longest Drive chip stays up top-right all hole, so you can log (or update) whenever you're ready — it never disappears on you." },
  { section: 'gps', route: '/gps', anchor: 'contest-ctp', title: 'Closest to Pin',
    body: "On a Closest to Pin hole you get this one as you reach the green — same deal, and a 🎯 chip stays up top so you can log or change it anytime, not just when the pop-up first appears." },
  { section: 'gps', route: '/gps', anchor: 'contest-measure', title: 'Measure it with GPS',
    body: "Say Yes and this opens. Stand over your ball and tap Measure — GPS logs your drive distance (or the feet to the pin for Closest to Pin). No tape measure needed." },
  { section: 'gps', route: '/gps', anchor: 'contest-photo', title: 'Add a photo (optional)',
    body: "Want proof? Snap a photo to ride along with your entry — perfect for settling any “no way you hit it that far” arguments." },
  { section: 'gps', route: '/gps', anchor: 'contest-submit', title: 'Submit your entry',
    body: "Hit Submit and you're on the board. Longest Drive ranks by measured yardage; Closest to Pin goes to whoever's latest and tightest." },
  { section: 'gps', route: '/gps', anchor: 'enter-score', title: 'Post your hole', interactive: true,
    body: "This is where you enter your team's score. Tap it to open your scorecard — go ahead, everything from here on is just practice and nothing you tap gets saved to the tournament." },
  { section: 'gps', route: '/gps', anchor: 'score-demo-score', pokeable: true, title: 'Set the team score',
    body: "It's a scramble, so it's one score for the team. Tap + or − to dial in your number — try it now, this is your sandbox." },
  { section: 'gps', route: '/gps', anchor: 'score-demo-drive', pokeable: true, title: 'Whose drive did you use?',
    body: "Pick which partner's tee shot the team played. Everyone has to use a minimum number of drives over the round, so this keeps it honest. Tap a name to try it." },
  ...
  { section: 'gps', route: '/gps', anchor: 'score-demo-save', pokeable: true, title: 'Set your putts',
    body: "Set your putts too. Score, putts and a drive are all required before you can post a hole (chulligans are optional). Once all three are in, you're ready to send it for approval. (Nothing's saved during the tour.)" },
  ...
  { section: 'leaderboard', route: '/leaderboard', anchor: 'lb-stats', title: 'The four numbers',
    body: "For each team: To Par (score against par), Gross (total strokes taken), Thru (holes completed — “F” means finished), and Putts (the first tiebreaker if teams are level). When score approvals are on, a hole only shows here once your group has approved it — a little note up top says how many are still pending, so the board can run a touch behind live play." },
  ...
  { section: 'leaderboard', route: '/leaderboard', anchor: 'ryder-tile', title: 'Waterbury Open',
    body: "When the Waterbury Open is on, this tile sits up top: two squads — blue vs red — racing to clinch. Each foursome is a match, winning a hole is a point (ties split ½ each), and the header totals it all up. Pure side-game fun — it never touches the main standings." },
  // ── Rules ──
  ...
  // ── Contests ──
  { section: 'contests', route: '/contests', anchor: 'contests-tabs', title: 'Contests & standings',
    body: "Closest to Pin, Longest Drive and the Jackass-of-the-Day vote all live here. You log CTP and LD out on the course — tap the contest chip (or pop-up) on the GPS screen — and this page is where the entries land and rank (Longest Drive by yards). Flip between them with these tabs." },
