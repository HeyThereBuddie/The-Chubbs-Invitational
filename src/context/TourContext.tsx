...
const STEPS: TourStep[] = [
  ...
  { section: 'gps', route: '/gps', anchor: 'contest-ld', title: 'Longest Drive pop-up',
    body: "On a Longest Drive hole this pops up the moment you walk off the tee. It only shows on contest holes — tap Yes to log your bomb, No to skip." },
  { section: 'gps', route: '/gps', anchor: 'contest-ctp', title: 'Closest to Pin pop-up',
    body: "On a par-3 contest hole you get this one as you reach the green. Same deal — and it tucks away the second you answer, so it never sits on top of your scorecard." },
  ...
  { section: 'contests', route: '/contests', anchor: 'contests-tabs', title: 'Contests & standings',
    body: "Closest to Pin, Longest Drive and the Jackass-of-the-Day vote all live here. You log CTP and LD out on the course from the GPS pop-ups — this page is where the entries land and rank (Longest Drive by yards). Flip between them with these tabs." },
