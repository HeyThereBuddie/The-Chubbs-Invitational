...
const HOLE_DATA: { yards: number; si: number; description?: string; photo?: string }[] = [
  ...
  { yards: 510, si: 3,  photo: `${BASE}/ROY-Hole-4.png`,  description: 'With water on the left and a long bunker on the right, a well played tee shot is a must. Calculate your yardage accurately, as this green is 50 yards deep. Because of the size of the green, a long first putt is very common. A 3 here is a great score.' },
  ...
  { yards: 410, si: 9,  photo: `${BASE}/ROY-Hole-7.png`,  description: 'Be aware of the pin position on this two-tier, 48 yard deep green. Remember to take more club as you are hitting uphill. This moderate length hole is quite the challenge. Play smart and avoid the big number here.' },
