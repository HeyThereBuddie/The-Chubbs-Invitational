        ...
        return (
          <button
            ...
            style={{
              ...
              border: `1px solid ${mine ? 'rgba(252,181,20,0.35)' : 'rgba(255,255,255,0.1)'}`,
              cursor: canReact ? 'pointer' : 'default',
              fontSize: 13, color: mine ? '#FCB514' : 'rgba(255,255,255,0.7)',
      ...
      {hasPicker && (
        <button
          ...
          style={{
            ...
            border: `1px solid ${pickerOpen ? 'rgba(252,181,20,0.3)' : 'rgba(255,255,255,0.1)'}`,
            cursor: 'pointer', fontSize: 15, lineHeight: 1,
            color: pickerOpen ? '#FCB514' : 'rgba(255,255,255,0.35)',
            transition: 'background 0.12s, border-color 0.12s',
          }}
        >
          {pickerOpen ? '×' : '+'}
